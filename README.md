...
2. Open **SQL Editor** → **New query**, paste and run each migration in order:
   ...
   - **`supabase/migrations/20260511100000_beer_gifts_claimed_count.sql`** (**`beer_gifts_claimed_count()`** so the home page can show how many beers have been claimed; anon cannot read claimed rows directly under RLS)  
